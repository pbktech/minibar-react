  ...
  return (
    ...
    <Form>
        ...
        <Form.Group as={Col} md="6">
          <Container>
            <Form.Row>
              ...
              <Form.Group as={Col} md="3">$6.49</Form.Group>
            </Form.Row>
            <Form.Row>
            <Form.Group as={Col} md="6">
              Subtotal:
          ...
          <Form.Group as={Col} md="3">$0.76</Form.Group>
        </Form.Row>
        <Form.Row>
        <Form.Group as={Col} md="6">
          Total:
        </Form.Group>
        <Form.Group as={Col} md="3">$7.25</Form.Group>
      </Form.Row>
          </Container>
        </Form.Group>
        </Form.Row>
      ...
      <Form.Row>
        <Form.Group as={Row}>
          <Col md="12">
            <Form.Check
            name="smsconsent"
            label="I consent to receive status updates about my order via SMS" checked />
            <Form.Check
            name="emailconsent"
            label="I consent to receive marketing emails from Protein Bar & Kitchen" />
          </Col>
        </Form.Group>
      </Form.Row>
      <Form.Row>
        <Col><h5>Billing Address</h5></Col>
      </Form.Row>
      <Form.Row>
        <Form.Group as={Col} md="6" controlId="validationCustom03">
      ...
      <Form.Row>
        ...
        <Form.Row>
          <Col><h5>Available Credits</h5></Col>
        </Form.Row>
        <Form.Row>
          <Form.Group as={Row}>
            <Col md="12">
